...
int createPlots()
{
 ...
 //-------------------------------------------
  ...
  editHist(h4L_eAu_eCa,1,1,kBlue,1,fullCircle,kBlue,false);
  editHist(h4L_eAu_ep,1,1,kBlue,2,fullDiamond,kBlue,false);
  editHist(h4T_eAu_eCa,1,1,kBlack,1,fullCircle,kBlack,false);
  editHist(h4T_eAu_ep,1,1,kBlack,2,fullDiamond,kBlack,false);
 
  TH1F *h4[4];
  for(int i = 0 ; i < 4 ; i++)
    h4[i]=new TH1F();
  editHist(h4[0],1,1,kBlue,2,fullCircle,kBlue,false);
  editHist(h4[1],1,1,kBlue,3,fullDiamond,kBlue,false);
  editHist(h4[2],1,1,kBlack,2,fullCircle,kBlack,false);
 ...
 //-------------------------------------------
  ...
  editHist(h5_eAu_JPsi,1,1,kBlack,1,openSquare,kBlack,true);
  editHist(h5_eCa_JPsi,1,1,kBlack,1,openCircle,kBlack,true);
  editHist(h5_ep_JPsi,1,1,kBlack,2,openDiamond,kBlack,true);
  editHist(h5_eAu_Phi,1,1,kBlue,1,openSquare,kBlue,true);
  editHist(h5_eCa_Phi,1,1,kBlue,1,openCircle,kBlue,true);
  editHist(h5_ep_Phi,1,1,kBlue,2,openDiamond,kBlue,true);
 
  TH1F *h5[6];
  for(int i = 0 ; i < 6 ; i++)
    h5[i]=new TH1F();
  editHist(h5[0],1,1,kBlack,2,openSquare,kBlack,true);
  editHist(h5[1],1,1,kBlack,2,openCircle,kBlack,true);
  editHist(h5[2],1,1,kBlack,3,openDiamond,kBlack,true);
  editHist(h5[3],1,1,kBlue,2,openSquare,kBlue,true);
  editHist(h5[4],1,1,kBlue,2,openCircle,kBlue,true);
  editHist(h5[5],1,1,kBlue,3,openDiamond,kBlue,true);
...
//-------------------------------------------
  ...
  editHist(h6_eAu_JPsi,1,1,kBlack,1,fullSquare,kBlack,true);
  editHist(h6_eCa_JPsi,1,1,kBlack,1,fullCircle,kBlack,true);
  editHist(h6_ep_JPsi,1,1,kBlack,2,fullDiamond,kBlack,true);
  editHist(h6_eAu_Phi,1,1,kBlue,1,fullSquare,kBlue,true);
  editHist(h6_eCa_Phi,1,1,kBlue,1,fullCircle,kBlue,true);
  editHist(h6_ep_Phi,1,1,kBlue,2,fullDiamond,kBlue,true);
 
  TH1F *h6[6];
  for(int i = 0 ; i < 6 ; i++)
    h6[i]=new TH1F();
  editHist(h6[0],1,1,kBlack,2,fullSquare,kBlack,true);
  editHist(h6[1],1,1,kBlack,2,fullCircle,kBlack,true);
  editHist(h6[2],1,1,kBlack,3,fullDiamond,kBlack,true);
  editHist(h6[3],1,1,kBlue,2,fullSquare,kBlue,true);
  editHist(h6[4],1,1,kBlue,2,fullCircle,kBlue,true);
  editHist(h6[5],1,1,kBlue,3,fullDiamond,kBlue,true);
